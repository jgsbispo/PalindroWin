...
// definindo variveis globais
bool resultClean = true;	// tela de resultado está limá
...
HWND		hwndLabel;		// identiicador para o label
HWND		hwndEdit;		// identificador para o edit controll
HWND		hwndButton;		// idenficador para o button
HFONT		appFont;		// font da aplicação
